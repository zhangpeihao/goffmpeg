...
#define FFMPEG_CONFIGURATION "--prefix=/usr --extra-cflags='-O3 -fpic -fasm' --disable-shared --disable-everything --disable-encoders --disable-decoders --disable-muxers --disable-avdevice --disable-avfilter --disable-demuxers --disable-debug --disable-logging --disable-doc --disable-ffplay --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --enable-nonfree --enable-version3 --enable-memalign-hack --enable-libvo-aacenc --enable-protocol=tcp --enable-protocol=file --enable-hwaccel=h264_vaapi --enable-hwaccel=h264_vaapi --enable-hwaccel=h264_dxva2 --enable-demuxer=h264 --enable-muxer=h264 --enable-decoder=h264 --enable-encoder=h264 --enable-parser=h264 --enable-decoder=aac --enable-encoder=aac --enable-decoder=flv --enable-encoder=flv --enable-demuxer=flv --enable-muxer=flv --enable-protocol=rtmp --enable-protocol=rtmpt --enable-decoder=nellymoser --enable-hwaccels --enable-avformat --enable-avcodec --enable-avresample --enable-zlib"
